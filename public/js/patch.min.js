...
var patch = function ($) {
  ...
  var containerEl = document.getElementById('canvas-container'),
      ...
      // initial state for multiple selection
  ...
  function setColor(shapeArea, i) {
    ...
    if (colorIndexData[i] !== null || colorIndexData[i] === undefined) {
      var currentColor = shapeArea.fillColor.toCSS(true),
          // Convert Paper.js Color object into hex
...
//# sourceMappingURL=maps/patch.js.map
