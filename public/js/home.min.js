...
var quiltsList = function ($) {
  ...
  function setButtonState() {
    ...
    $quiltNav.each(function (i, v) {
      ...
      if (direction === 'prev' && currentQuiltIndex === 0 || direction === 'next' && currentQuiltIndex === quilts.length - 1) {
  ...
  return {
    ...
    disable: function (_disable) {
      ...
      disable.toString = function () {
        return _disable.toString();
      };
...
(function ($, window) {
  ...
  var Home = {
    ...
    checkVisit: function checkVisit() {
